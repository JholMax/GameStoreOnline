...
class Nelio_AB_Testing_Account_Page extends Nelio_AB_Testing_Abstract_Page {
	...
	public function __construct() {
		...
		if ( nab_is_subscribed() ) {
			$menu = _x( 'Account', 'text', 'nelio-ab-testing' );
			$page = _x( 'Account Details', 'text', 'nelio-ab-testing' );
		} else {
			$menu = _x( 'Premium', 'text', 'nelio-ab-testing' );
			$page = _x( 'Upgrade to Nelio A/B Testing Premium', 'user', 'nelio-ab-testing' );
		}//end if
