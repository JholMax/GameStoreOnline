...
class Nelio_AB_Testing {
	...
	private function load_dependencies() {
		...
		// phpcs:ignore
		include_once $this->plugin_path . '/includes/experiments/hooks/index.php';
		// phpcs:ignore
		include_once $this->plugin_path . '/includes/conversion-actions/hooks/index.php';
	...
	private function install() {
		...
		$aux = Nelio_AB_Testing_Experiment_Migrator::instance();
		$aux->init();
	...
	public function is_ready() {
		...
		if ( get_option( 'nab_migrate_old_experiments', false ) ) {
			return false;
		}//end if
	...
	private function init_common_helpers() {
		...
		$aux = Nelio_AB_Testing_Cache_Manager::instance();
		$aux->init();
