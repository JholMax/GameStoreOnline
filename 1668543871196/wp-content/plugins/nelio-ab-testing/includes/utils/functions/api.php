 ...
 * @param int $value       Optional. Value (positive number) associated with the conversion.
 *
 * @since 5.0.0
 * @since 5.1.0 Add `$value` param.
 */
function nab_track_conversion( $experiment, $goal, $alternative, $value = 0 ) {
	...
	$url = add_query_arg(
		array(
			// phpcs:ignore
			'e' => rawurlencode( base64_encode( wp_json_encode( array( $event ) ) ) ),
