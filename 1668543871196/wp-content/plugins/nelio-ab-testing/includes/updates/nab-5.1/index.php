...
function add_old_testing_hooks() {
	...
	// Attributes.
	add_filter(
		'nab_nab/product-summary_get_default_attributes_in_control',
		$namespace . '\get_default_attributes_in_control'
	);
	add_filter(
		'nab_nab/product-summary_get_default_attributes_in_alternative',
		$namespace . '\get_default_attributes_in_alternative'
	);
