	...
	register_rest_route(
		...
		array(
			array(
				...
				'permission_callback' => __NAMESPACE__ . '\get_permissions_for_duplicating_widgets',
...
function get_permissions_for_duplicating_widgets( $request ) {
	return true;
}//end get_permissions_for_duplicating_widgets()
