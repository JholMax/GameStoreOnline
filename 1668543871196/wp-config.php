...
define('WP_PLUGIN_URL', 'http://localhost:81/wordpress/1668543871196/wp-content/plugins'); 
define('WP_LANG_DIR', __DIR__ . "/wp-content/languages"); 
define('WP_HOME', 'http://localhost:81/wordpress/1668543871196'); 
define('WP_SITEURL', 'http://localhost:81/wordpress/1668543871196'); 
